...
test('digitize()', () => {
    ...
    expect(digitize(1, {minimumDigits: 20})[0]).toHaveLength(20);
    expect(digitize([1, [1, 2020]], {minimumDigits: 20})[0]).toHaveLength(15);
    expect(digitize([1, [1, 2020]], {minimumDigits: 20})[1]).toHaveLength(5);
